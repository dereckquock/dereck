...
- [React Context]() for having a fun dark mode
  ...
  effectively](https://kentcdodds.com/blog/how-to-use-react-context-effectively) really helped me execute this easily 🔥

### 🏈 [NFL Stadiums VR blog](https://github.com/dereckquock/treydos)

React 360 VR blog that shows a more immersive experience of different NFL stadiums that we've visited. We're utilizing
our 360 camera and wanted to create a React 360 tour app so others can get a feel for the different stadiums and even
plan to visit themselves. Our journey to visit all the stadiums is still a work in progress and I'll rebuild this
sometime soon.
