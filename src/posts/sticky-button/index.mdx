...
Just as we set `bottom: 0` to make our **Continue** button stick to the bottom, setting `top: 0` on the sticky
...
![Spider-Man](https://media.giphy.com/media/9tZc9Mzo9K0yOYx38U/giphy.gif)
