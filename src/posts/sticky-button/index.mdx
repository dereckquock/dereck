...
description: How we used sticky positioning for our call-to-action button to improve conversion
image: ./featured.jpg
...
heading in a list, but it's the perfect use case for our **Continue** button.
...
Now the customer doesn't necessarily _need_ to scroll all the way down if they want to check out quickly.
