...
and with the help of [react-native-redash](https://github.com/wcandillon/react-native-redash) from
William Candillon, who does the [_Can it be done in React Native_ videos on
YouTube](https://www.youtube.com/user/wcandill), it was a lot more painless.
...
The [loop() function](https://wcandillon.github.io/react-native-redash/run-animations#loop)
makes this easier to do and with the `boomerang` option set to `true`, the
opacity will bounce back and forth from 0 to 1 🦘
