...
I'm using [emotion](https://emotion.sh) and I was seeing how to implement media queries on this website. I stumbled
upon using [facepaint](https://github.com/emotion-js/facepaint) to define reusable media queries.
...
[![Edit facepaint with styled components +
props](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/facepaint-with-styled-components-props-9isof?fontsize=14&hidenavigation=1&theme=dark)
